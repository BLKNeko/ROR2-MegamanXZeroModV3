...
{
    public class Slash3 : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            base.PlayAnimation("Gesture, Override", "ZSlash3", "attackSpeed", this.duration);
            ...
            this.attack.damageType = (Util.CheckRoll(35f, base.characterBody.master) ? DamageType.Stun1s : DamageType.Generic);
            this.attack.attacker = base.gameObject;
            this.attack.inflictor = base.gameObject;
            this.attack.teamIndex = base.GetTeam();
            this.attack.damage = dmg * this.damageStat;
            this.attack.procCoefficient = 1;
            this.attack.hitEffectPrefab = Slash3.hitEffectPrefab;
        ...
        public void FireAttack()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    ...
                    if (this.attack.Fire())
                    {
                        if (Util.CheckRoll((40f + base.characterBody.level), base.characterBody.master))
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.fixedAge >= (this.duration) && base.isAuthority && base.inputBank.skill1.down)
            {
                ...
                //else index = 0;
                Slash S1 = new Slash();
                Slash4 S4 = new Slash4();

                if (base.characterBody.level >= 5)
                    this.outer.SetNextState(S4);
                else
