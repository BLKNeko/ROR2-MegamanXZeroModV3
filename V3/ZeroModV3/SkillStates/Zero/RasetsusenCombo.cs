...
{
    public class RasetsusenCombo : BaseSkillState
    {
        ...
        public float initialSpeedCoefficient = 6.4f;

        // Token: 0x0400392F RID: 14639

        public float finalSpeedCoefficient = 5.95f;
        ...
        public override void OnEnter()
        {
            ...
            this.earlyExitDuration = RasetsusenCombo.baseEarlyExit / this.attackSpeedStat;
            this.hasFired = false;
            ...
            base.PlayAnimation("FullBody, Override", "ZAerial", "attackSpeed", this.duration);
            ...
            Util.PlaySound(Sounds.zRasetsusen, base.gameObject);
            ...
            if (RasetsusenCombo.jetEffect)
            {
                Transform transform = component.FindChild("LeftJet");
                Transform transform2 = component.FindChild("RightJet");
                if (transform)
                {
                    UnityEngine.Object.Instantiate<GameObject>(RasetsusenCombo.jetEffect, transform);
                }
                if (transform2)
                {
                    UnityEngine.Object.Instantiate<GameObject>(RasetsusenCombo.jetEffect, transform2);
                }
            ...
            float dmg = RasetsusenCombo.damageCoefficient;
            ...
            this.attack.hitEffectPrefab = RasetsusenCombo.hitEffectPrefab;
        ...
        public void FireAttack()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    base.AddRecoil(-1f * RasetsusenCombo.attackRecoil, -2f * RasetsusenCombo.attackRecoil, -0.5f * RasetsusenCombo.attackRecoil, 0.5f * RasetsusenCombo.attackRecoil);
                    ...
                    if (this.attack.Fire())
                    {
                        ...
                        if (!this.hasHopped)
                        {
                            ...
                            {
                                base.SmallHop(base.characterMotor, RasetsusenCombo.hitHopVelocity);
                            }
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.fixedAge >= this.duration && base.isAuthority)
            {
                ...
                if (base.characterBody.inputBank.skill4.down)
