...
{
    public class ZSSlashCombo2 : BaseMeleeAttackZP
    {
        ...
        public override void OnEnter()
        {
            ...
            damageCoefficient = ZeroStaticValues.ZSaber2DamageCoefficient;
            procCoefficient = 1f;
            pushForce = 300f;
            ...
            else if (base.characterBody.level >= ZeroConfig.ZeroFirstUpgradeInt.Value)
