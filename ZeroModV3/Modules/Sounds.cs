...
namespace ZeroModV3.Modules
{
    public static class Sounds
    {
        ...
        public static readonly string zCharging = "CallCharging";
        public static readonly string zFullCharge = "CallFullCharge";
        public static readonly string zTakeThis = "CallZeroTakeThis";
        public static readonly string zEnkoujinSFX = "CallZeroEnkoujinSFX";
        public static readonly string zEnkoujinVoice = "CallZeroEnkoujin";
