...
namespace ZeroModV3.Modules
{
    internal static class Assets
    {
        ...
        public static GameObject fireeffect2;

        public static GameObject GroundImpactFire;
        ...
        public static Texture ZIcon;
        public static Sprite ZPassiveIcon;
        public static Sprite ZSaber;
        public static Sprite ZBuster;
        public static Sprite ZDash;
        public static Sprite ZDefense;
        public static Sprite ZRyouenjin;
        public static Sprite ZSkin;
        ...
        // CHANGE THIS
        private const string assetbundleName = "zerov3bundle";
        //change this to your project's name if/when you've renamed it
        private const string csProjName = "ZeroModV3.";
        ...
        internal static void LoadAssetBundle()
        {
            if (mainAssetBundle == null)
            {
                ...
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("ZeroModV3." + "zerov3bundle"))
                {
        ...
        internal static void LoadSoundbank()
        {
            ...
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("ZeroModV3." + "HenryBank.bnk"))
            {
        ...
        internal static void PopulateAssets()
        {
            ...
            fireeffect = Assets.LoadEffect("VFXFire1", "");
            iceeffect = Assets.LoadEffect("VFXIce1", "");
            GroundImpactFire = Assets.LoadEffect("VFXGroundImpactFireBig", "");

            ZIcon = mainAssetBundle.LoadAsset<Texture>("ZeroDisplay");
            ZPassiveIcon = mainAssetBundle.LoadAsset<Sprite>("ZeroPassiveSkillIcon");
            ZSaber = mainAssetBundle.LoadAsset<Sprite>("ZSaberIcon");
            ZBuster = mainAssetBundle.LoadAsset<Sprite>("ZBusterIcon");
            ZDefense = mainAssetBundle.LoadAsset<Sprite>("ZGuardIcon");
            ZDash = mainAssetBundle.LoadAsset<Sprite>("ZDashIcon");
            ZRyouenjin = mainAssetBundle.LoadAsset<Sprite>("ZeroRyuenjiIcon");
            ZSkin = mainAssetBundle.LoadAsset<Sprite>("ZeroSkinIcon");
        }
